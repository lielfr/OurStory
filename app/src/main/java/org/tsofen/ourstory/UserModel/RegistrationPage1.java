...
public class RegistrationPage1 extends AppCompatActivity {
    ...
    public void Go2RegistrationPage2(View view) {
        ...
        EditText1 = (EditText)findViewById(R.id.showEmail);
        EditText2 = (EditText)findViewById(R.id.showFirst);
        EditText3 = (EditText)findViewById(R.id.showLast);
        EditText4 = (EditText)findViewById(R.id.password_editText);
        EditText5 = (EditText)findViewById(R.id.repeatpassword_editText);
