...
public class SearchMemoryAdapter extends RecyclerView.Adapter<SearchMemoryAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public SearchMemoryAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        SearchMemoryAdapter.ViewHolder viewHolder = new SearchMemoryAdapter.ViewHolder(contactView, this);
...
//    }
    @Override
    public void onBindViewHolder(@NonNull SearchMemoryAdapter.ViewHolder holder, int position) {
